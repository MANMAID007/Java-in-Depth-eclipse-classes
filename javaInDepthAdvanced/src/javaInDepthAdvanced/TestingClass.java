...
//        System.out.println("Insurance will pay: "+payments[0]+"\n"+"Patient will pay: "+payments[1]);
    	...
    	stuff.setInsurancePlan(insurancePlan);
    	//insurancePlan.computeMonthlyPremium(5000, 86, true);
    	
    	System.out.println(insurancePlan.computeMonthlyPremium(5000, 86, true));
    }
}
